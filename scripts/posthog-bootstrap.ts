 ...
 * suites can coexist in one PostHog account (e.g. "Overview — Magnet").
 *
 * It also:
...
const LANDING_FLAG_KEY = "home-page-variant-magnet";
const LANDING_FLAG_NAME = "Feature Flag for Experiment Home page A/B test — Magnet";
const LANDING_EXPERIMENT_NAME = "Home page A/B test — Magnet";
const LANDING_EXPERIMENT_DESC =
  "A/B test of the magnet landing page. Visitors landing on / are redirected server-side to /v1 " +
...
async function main() {
  ...
  const deployedUrl = await promptDeployedUrl("magnet.dastyare.social");

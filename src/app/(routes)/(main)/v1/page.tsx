...
import LandingWhyThisGuideIsDifferentSectionV1 from "./_sections/why-this-guide-different";
...
const Page = () => {
  return (
    <WindowLayout>
      ...
      <LandingWhyThisGuideIsDifferentSectionV1 webhookUrl={process.env.WEBHOOK_URL} />
